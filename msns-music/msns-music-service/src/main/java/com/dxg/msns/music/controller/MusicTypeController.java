...
public class MusicTypeController {
    ...
    public ResponseEntity<MusicType> queryById(@PathVariable("id")Integer id){
        MusicType musicType = musicTypeService.queryById(id);
        return ResponseEntity.ok(musicType);
    }
}
