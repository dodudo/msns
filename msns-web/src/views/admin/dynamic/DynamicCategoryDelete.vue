                ...
                <v-toolbar flat color="white">
                    ...
                    <v-dialog v-model="dialog" max-width="500px">
                        <template v-slot:activator="{ on }">
                            <v-btn color="primary" dark class="mb-2" v-on="on">新增分类</v-btn>
                        </template>
                        <v-card>
                            <v-card-title>
                                    ...
                                    <v-form v-model="valid" ref="typeForm">
                                        <v-row>
                                            <v-col cols="12" sm="6" md="4">
                                                <v-text-field required :rules="typenameRules"
                                                              v-model="editedItem.typeName"
                                                              label="类型名"></v-text-field>
                                            </v-col>
                                            <v-col cols="12" sm="6" md="4">
                                                <v-switch
                                                        required
...
<script>
    export default {
        ...
        methods: {
            initialize() {
                this.$http.get("/dynamic/category/page", {
                    params: {
                        key: this.search,
